/**
 * POST /api/evertec/device/reprint
...
export async function GET() {
  return createApiDocumentation({
    endpoint: '/api/evertec/device/reprint',
    description: 'Reprints last receipt',
    requestBody: {
      type: 'object',
